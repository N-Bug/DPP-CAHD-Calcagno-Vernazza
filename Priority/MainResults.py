...
if __name__ == "__main__":
    ...
    max_attempts = 5  # Numero test completi
    ...
    min_priority = 0.05
    max_priority = 2
    kl_attempts = 4  # Numero di volte in cui viene eseguita la KL_Divergence con QID diversi
    r = 5  # Numero di QID considerati nella KL_Divergence
